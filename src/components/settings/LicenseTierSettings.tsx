...
import { LicenseTierRow } from "./LicenseTierRow";
import { LicenseTierDialogForm } from "./LicenseTierDialogForm";
...
export function LicenseTierSettings() {
  ...
  function handleSave(form: { name: string; description: string; durationYears: number; color: string; cost: number }) {
  ...
  return (
    <Card>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <LicenseTierDialogForm
          initial={editTier || undefined}
          mode={editTier ? "edit" : "add"}
          open={dialogOpen}
